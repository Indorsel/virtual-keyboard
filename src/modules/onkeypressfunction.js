...
// // const keyboard = new Keyboard(arr, options);
// // keyboard.render();
// // keyboard
// // .then(
// //   function fulfilled() {
...
//     //   const keyboardElement = document.createElement('div')
//     //   // const keyValue = keyCodeFormatter(keyList[i].keyCode)
//     //   keyboardElement.innerText = arr[i].value  // change to keyValue if need
//     //   keyboardElement.setAttribute('onclick', `${() => pressKey}`)
//     //   keyboardElement.classList.add('key')
//     //   wrapper.append(keyboardElement)
//     // }